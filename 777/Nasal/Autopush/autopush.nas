...
var _loop = func() {
    ...
    if ((getprop("services/ext-pwr/enable") or getprop("services/fuel-truck/enable") or getprop("services/chocks/nose") or getprop("services/chocks/left") or getprop("services/chocks/right") or getprop("services/payload/baggage-truck1-enable") or getprop("services/payload/baggage-truck2-enable") or getprop("services/catering/truck[0]/connect") or getprop("services/catering/truck[1]/connect") or getprop("services/catering/truck[2]/connect") or getprop("services/catering/truck[3]/connect") or getprop("services/stairs/stairs1_enable") or getprop("services/stairs/stairs2_enable") or getprop("services/stairs/stairs3_enable") or getprop("services/deicing_truck/enable") ) and (getprop("sim/model/autopush/target-speed-km_h") != 0)) {
