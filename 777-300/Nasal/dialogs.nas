...
var tiller_steering = gui.Dialog.new("sim/gui/dialogs/tiller-steering/dialog",
        "Aircraft/777-300/Systems/tiller-steering.xml");

var handy_viewer = gui.Dialog.new("sim/gui/dialogs/handy_viewer/dialog",
		"Aircraft/777-300/Systems/handy_viewer.xml");

var holding = gui.Dialog.new("sim/gui/dialogs/holding/dialog",
        "Aircraft/777-300/gui/dialogs/holding-dlg.xml");
