...
var mfdReload= func() {
    ...
    mfdDel();
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-300/Models/Instruments/MFD/mfd.nas","b777");
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-300/Models/Instruments/MFD/fuel.nas","b777");
    mfdCreate();
}